...
const patients = [
  {
    ...
    date: "Aug 2025",
    image: "/images/dental-aligns/after.jpg",
  },
  {
    name: "R. Meena",
    ...
    <section className="before-after">
      <div className="before-after-container">
        ...
        >
          ...
          <p>
            Every smile reflects precision aligner technology and
            expert-driven treatment planning.
          </p>
        </motion.div>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <ul>
                ...
                <li><strong>Completed:</strong> {patient.date}</li>
              </ul>
